...
function defaultOptions (options) {
  ...
  return {
    ...
    graphQLExpandedTypes: isUndefined(options.graphQLExpandedTypes) ? ['Maybe', 'Scalar'] : options.graphQLExpandedTypes,
...
async function projectToOpenApi (options) {
  ...
  if (typeof projectConfig.jsonSchema !== undefined) {
    await jsonSchemaToOpenApi(options)
  }

  if (typeof projectConfig.typeScript !== undefined) {
    await typeScriptToOpenApi(options)
  }
